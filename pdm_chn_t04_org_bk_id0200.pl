...
DELETE FROM ${BASE::CHN_RPSDATADB}.DTL_ORG_BK_ID ALL
.IF ERRORCODE <>0 THEN.COTO QUITQITHERROR
;

.IF ERRORCODE <> 0 THEN .GOTO QUITWITHERROR;


INSERT INTO ${BASE::CHN_RPSDATADBI}.DTL_ORG_BK_ID
BK_ID 
,BK NAME 
,SUB BK ID 
,SUB_BK_NAME 
...
,SUB BK_ID 
，SUB_BK_NAME 
FROM ${BASE::CHN_PDMVIEWDB}.TO4_ORG_BK_ID
.IF ERRORCODE<>0 THEN .GOTO QUITQITHERROR
